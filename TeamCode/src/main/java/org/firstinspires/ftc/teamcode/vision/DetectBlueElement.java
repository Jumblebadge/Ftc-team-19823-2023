...
public class DetectBlueElement implements VisionProcessor {
    ...
    Telemetry telemetry;
    double leftSaturation, midSaturation, rightSaturation;
    ...
    public DetectBlueElement(Telemetry telemetry) {
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        leftSaturation = getSaturation(frame, left);
        midSaturation = getSaturation(frame, middle);
        rightSaturation = getSaturation(frame, right);
    ...
    public void onDrawFrame(Canvas canvas, int onscreenWidth, int onscreenHeight, float scaleBmpPxToCanvasPx, float scaleCanvasDensity, Object userContext) {
        ...
        telemetry.addData("midsat",midSaturation);
        telemetry.addData("rightsat",rightSaturation);
        telemetry.update();
        switch(detected) {
            case LEFT:
