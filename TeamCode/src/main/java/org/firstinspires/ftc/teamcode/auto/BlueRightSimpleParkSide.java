...
public class BlueRightSimpleParkSide extends LinearOpMode {
            ...
            switch(apexstate){
                case SPIKE:
                    ...
                    if (taskNumber == 1 && goofytimer.seconds() > 0.75) {
                        intake.off();
                        gvf.setPath(BluePathList.LeftSpikeToBoard, 3.5, 30, 0.5);
                        taskNumber = 0;
                        targetHeading = -90;
                        camera.enableAprilTag(true);
                        apexstate = BlueRightSimpleParkSide.apexStates.CYCLE;
                    }
                    break;
