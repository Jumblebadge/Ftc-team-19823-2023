...
@Config
@Autonomous(name="Red Left Park Side", group="Linear Opmode")
public class RedLeftSimpleParkSide extends LinearOpMode {
            ...
            switch(apexstate){
                case SPIKE:
                    ...
                    if (taskNumber == 1 && goofytimer.seconds() > 0.75) {
                        ...
                        apexstate = RedLeftSimpleParkSide.apexStates.CYCLE;
                    }
                    break;
